...
function from_css_code_v2(HX, HZ, ctx::Z3.ContextAllocated)
    n = size(HX, 2)
    ...
    return (stabilizer1, phases1, dx, dz)
end
...
CNOT, H, S, X, Y, Z, sY, sZ, M = CNOT!, H!, S!, X!, Y!, Z!, sY!, sZ!, M!
...
function solve_constraints(slv_backend_cmd::Cmd=`bitwuzla --smt-comp-mode true -rwl 0 -S kissat`)
    smt2_file_name = "_temp_check_preconditons_"
